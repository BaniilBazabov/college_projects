...
export default class CreateTherapists extends Component {
    constructor(props){
        super(props);
    ...
    onSubmit(e){
        ...
        axios.post('http://localhost:8000/Therapists', user)
    ...
    render(){
        return (
            <div>
                <h2>Add a therapist to the Database!</h2>
                <form onSubmit={this.onSubmit}>
                    <div className="form-group">
                        ...
                        <div className="form-group">
                            <input type="submit" value="Add The Therapist!" className="btn btn-primary"></input>
                        </div>
